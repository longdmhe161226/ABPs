...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p df1679bb-babf-4395-b8ee-30bf408dd477
```

> `df1679bb-babf-4395-b8ee-30bf408dd477` is the password of the certificate, you can change it to any password you want.
