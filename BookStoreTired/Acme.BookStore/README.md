...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p a64df57e-eb1d-44f4-a6a0-df0f3708101b
```

> `a64df57e-eb1d-44f4-a6a0-df0f3708101b` is the password of the certificate, you can change it to any password you want.
