...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p e702532d-6a81-4891-bc97-10b7ed26110b
```

> `e702532d-6a81-4891-bc97-10b7ed26110b` is the password of the certificate, you can change it to any password you want.
